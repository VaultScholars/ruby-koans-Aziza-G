...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # ---> Provides and preserves an accumulator across iterations, replacing the 
    # accumulator with the result of the block on each iteration. 
  end
  ...
  #   # code to read 'file'
  #-----> The block form automatically closes the file when the block exists. 
